...
class FriendshipModel(Base, TimestampMixin):
    ...
    sender: Mapped[uuid.UUID] = mapped_column("cl_2b", UUID(as_uuid=True), ForeignKey("tb_0.cl_0a"), nullable=False)
    reciver: Mapped[uuid.UUID] = mapped_column("cl_2c", UUID(as_uuid=True), ForeignKey("tb_0.cl_0a"), nullable=False)
