...
class ChatModel(Base, TimestampMixin):
    ...
    sender: Mapped[str] = mapped_column("cl_3b", String, ForeignKey("tb_0.cl_0a"), nullable=False)
    reciver: Mapped[str] = mapped_column("cl_3c", String, ForeignKey("tb_0.cl_0a"), nullable=False)
